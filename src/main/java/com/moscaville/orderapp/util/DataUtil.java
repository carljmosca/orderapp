package com.moscaville.orderapp.util;
...
import com.moscaville.orderapp.model.Shift;
...
public class DataUtil {
    ...
    public static Collection<CustomerOrder> generateDummyTickets() {

        final List<Topping> locations = Lists.newArrayList();
        ...
        Collection<CustomerOrder> result = Lists.newArrayList();
        for (Topping location : locations) {
    ...
    private static CustomerOrder createRandomTicket(final Topping location) {
        final Random random = new Random();
        final CustomerOrder ticket = new CustomerOrder();
        ...
        ticket.setViolation(Coating.values()[random.nextInt(Coating
                .values().length)]);
    ...
    private static Topping createLocation(final String address,
    ...
    public static void persistTickets(final List<CustomerOrder> tickets) {
        for (CustomerOrder ticket : tickets) {
            if (ticket != null) {
    ...
    public static void persistTicket(final CustomerOrder ticket) {
        ticket.setMyTicket(true);
        Topping location = ticket.getLocation();
    ...
    private static void determineTicketLocation(final CustomerOrder ticket) {
