...
public class TicketDetailPopover extends Popover {
    ...
    private final DateFormat dateFormat = DateFormat.getDateInstance(
            DateFormat.SHORT, MainUI.getApp().getLocale());
    private final DateFormat timeFormat = DateFormat.getTimeInstance(
            DateFormat.SHORT, MainUI.getApp().getLocale());

    public TicketDetailPopover(final CustomerOrder ticket) {
    ...
    private Component buildTicketLayout(final CustomerOrder ticket) {
    ...
    private void openImagePopup(final CustomerOrder ticket) {
    ...
    private Component buildTicketInfoLayout(final CustomerOrder ticket) {
        CssLayout layout = new CssLayout();
