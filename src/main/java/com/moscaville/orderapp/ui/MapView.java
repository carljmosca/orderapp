...
public class MapView extends CssLayout implements PositionCallback,
    ...
    private final BeanItemContainer<CustomerOrder> ticketContainer = MainUI
            .getTicketContainer();
    ...
    public final void updateMarkers() {
        List<CustomerOrder> tickets = ticketContainer.getItemIds();
        ...
        remove.stream().forEach((component) -> {
    ...
    private void showPopup(final CustomerOrder ticket) {
    ...
    public void onClick(final LeafletClickEvent event) {
        ...
        if (o instanceof AbstractComponent) {
            ...
            CustomerOrder ticket = (CustomerOrder) component.getData();
            showPopup(ticket);
        }
    }
}
