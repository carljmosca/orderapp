...
import com.moscaville.orderapp.widgetset.client.OfflineDataService;
...
public class TicketViewWidget extends VOverlay implements OfflineMode,
    ...
    public TicketViewWidget() {
        ...
        checkDeviceSize();
        ticketUpdated(new CustomerOrder(), true);
    }
    ...
    private void saveTicket() {
        ...
        if (validateFields()) {
            ...
            validateFields = false;
            CustomerOrder ticket = getTicket();
    ...
    public interface TicketViewWidgetListener {
        void persistTicket(CustomerOrder ticket);
    ...
    private CustomerOrder getTicket() {
        CustomerOrder ticket = new CustomerOrder();
    ...
    protected final void ticketUpdated(final CustomerOrder ticket,
